const t = {
  'pt-BR': {
    ...
    'projects.newFolder':                 '+ Nova Pasta',
    'projects.folder.ungroupedTitle':     'Sem pasta',
    'projects.folder.empty':              'Arraste um projeto para cá.',
    'projects.folder.project':            'projeto',
    'projects.folder.projects':           'projetos',
    'projects.folder.create':             'Criar pasta',
    'projects.folder.createTitle':        'Nova pasta',
    'projects.folder.namePlaceholder':    'Nome da pasta',
    'projects.folder.rename':             'Renomear pasta',
    'projects.folder.renameTitle':        'Renomear pasta',
    'projects.folder.delete':             'Excluir pasta',
    'projects.folder.deleteConfirm':      'Tem certeza que deseja excluir esta pasta? Os projetos não serão apagados, apenas voltarão para "Sem pasta".',
    'projects.folder.removeFromFolder':   'Remover da pasta',
  ...
  en: {
    ...
    'projects.folder.ungroupedTitle':     'Ungrouped',
    'projects.folder.empty':              'Drag a project here.',
    'projects.folder.project':            'project',
    'projects.folder.projects':           'projects',
    'projects.folder.create':             'Create folder',
    'projects.folder.createTitle':        'New folder',
    'projects.folder.namePlaceholder':    'Folder name',
    'projects.folder.rename':             'Rename folder',
    'projects.folder.renameTitle':        'Rename folder',
    'projects.folder.delete':             'Delete folder',
    'projects.folder.deleteConfirm':      'Are you sure you want to delete this folder? Projects will not be deleted, they will just move back to "Ungrouped".',
    'projects.folder.removeFromFolder':   'Remove from folder',
